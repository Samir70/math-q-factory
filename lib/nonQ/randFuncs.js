 ...
 * 
 * @param {string} t 
 * @returns {integer} a random prime, small if t = 'small'
 */
 ...
 * @returns array of two numbers (shuffled if argument is set to true)
 */
const randomCoprimePair = (shuffle = true) => shuffle ? shuffleFY(randomElement(coprimePairs)) : randomElement(coprimePairs)
