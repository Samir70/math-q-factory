...
const selector = {
    tables2to9: (a, b) => {
        ...
        return {
            q: `What is ${a * b} / ${b}`, a: a,
            hint: `Can you find ${a * b} in the ${b} times table?`,
            giveAway: `The ${b} times table is ${table.join(', ')}`,
            qFeedback: `${a * b} / ${b} = ${a}`
        }
    },
    tablesWithRemainder: (a, b, leftOver, person) => {
        ...
        return {
            ...
            a: leftOver,
            hint: `What is the biggest number less than ${a * b + leftOver} in the ${b} times table?`,
            giveAway: `The ${b} times table is ${table.join(', ')}. ${a * b} is the biggest number less than ${a * b + leftOver}`,
