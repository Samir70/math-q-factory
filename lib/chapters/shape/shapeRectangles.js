...
const selector = {
    ...
    areaFromPerimSide: (len, wid, area, perim) => {
        return {
            ...
            buildingBlocks: [
                'shape-rectangle-wFromPerimL-80', 'shape-rectangle-areaFromLW-75'
            ],
    ...
    wFromPerimL: (len, wid, area, perim) => {
        return {
            ...
            buildingBlocks: [
                'shape-rectangle-perimFromLW-75'
            ],
    ...
    perimFromAreaSide: (len, wid, area, perim) => {
        return {
            ...
            buildingBlocks: [
                'shape-rectangle-wFromAreaL-85', 'shape-rectangle-perimFromLW-75'
            ],
            qFeedback: `The width is ${wid} \nmaking the perimeter ${perim}`
        }
    }
