...
const selector = {
    sameDenom: ({ simp1 }) => {
        ...
        return {
            ...
            hint: `Both fractions would cut a cake into ${bottom} slices`,
            giveAway: `The ${top1 > top2 ? 'first' : 'second'} fraction has more of the ${bottom} slices`,
    ...
    sameNumer: ({simp1}) => {
        ...
        return {
            ...
            hint: `Both fractions are taking ${top} of the available slices`,
            giveAway: `The ${bottom1 < bottom2 ? 'first' : 'second'} fraction would cut a cake into bigger slices`,
    ...
    noMatch: ({ big1, big2, simp1, simp2 }) => {
        ...
        return {
            ...
            a: ans,
            hint: `It would be easier to tell which is bigger if the fractions had the same denominator.`,
            giveAway: `Convert both fractions to something over ${big1[1]}`,
