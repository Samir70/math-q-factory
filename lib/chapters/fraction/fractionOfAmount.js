...
const selector = {
    oneSlice: (top, bottom, amount) => {
        ...
        return {
            ...
            a: (amount / bottom),
            hint: `Which number in the fraction tells us how many slices to cut a cake into?`,
            giveAway: `We need to find one ${sliceNames[bottom]}, so share ${amount} into ${bottom} pieces`,
    ...
    manySlices: (top, bottom, amount) => {
        ...
        return {
            ...
            q: `Find ${frac} of ${amount}`,
            a: (amount / bottom) * top,
            hint: `Share ${amount} into ${bottom} pieces, take ${top} out of the ${bottom} pieces`,
            giveAway: `One slice is worth ${amount/bottom} \nHow many slices do we need?`,
    ...
    mixedNumber: (top, bottom, amount, wholeBoxes, name) => {
        ...
        return {
            ...
            hint: `The ${wholeBoxes} boxes all contain the same amount of chocolates`,
            giveAway: `To find ${frac} of a box, "divide by the bottom, times by the top"`,
