...
const sectionSetup = (qName) => {
    ...
    return {
        ...
        hints: [`Work through the BBC bitesize pages at:\n https://www.bbc.co.uk/bitesize/guides/zthsgk7/revision/1`],
        qFeedback: `There are ${rates[unitPair]} ${abbrevs[unit1]}s in a ${abbrevs[unit2]}`
    }
}
