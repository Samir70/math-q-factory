...
const selector = {
    rational: ({top, bottom, cFrac}) => {
        ...
        return {
            ...
            a: cFracFormat(cFrac),
            hints: [top > bottom ? `Write the fraction as a mixed number. The first partial quotient is the whole part` : `Because the fraction is less than one, the first part partial quotient is zero`],
            link: 'http://www.maths.surrey.ac.uk/hosted-sites/R.Knott/Fibonacci/cfINTRO.html',
    ...
    findConvergents: ({cFrac}) => {
        return {
            ...
            hints: ['This is not easy or quick to describe. Maybe try googling.'],
            link: 'http://www.maths.surrey.ac.uk/hosted-sites/R.Knott/Fibonacci/cfINTRO.html',
