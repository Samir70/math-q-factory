...
const simplifyWithUnits = () => {
    ...
    return {
        ...
        hints: [
            `Convert both measures into ${qData.commonUnit}`,
            `If you convert both measures in the ratio to ${qData.commonUnit} you get the ratio ${qData.noUnitsRatio} which you still need to simplify`,
        ],
        buildingBlocks: ['ratio-simplify-noUnits2-80'],
