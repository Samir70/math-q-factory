    ...
    givenDiff: (names, basicRatio, ansRatio, askAbout) => {
        ...
        return {
            ...
            hints: [
                ...
                `Keep sharing £${basicRatio.reduce((a, c) => a + c, 0)} until ${names[askAbout[0]]} gets £${Math.abs(ansRatio[askAbout[0]] - ansRatio[askAbout[1]])} ${comparison} than ${names[askAbout[1]]}`,
            ],
            qFeedback
        }
    }
