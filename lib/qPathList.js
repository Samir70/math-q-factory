...
for (let chapter in shortAnswerPaths) {
    if (chapter === 'totalQs') { continue }
    shortAnswerPaths.totalQs[chapter] = 0
    for (let section in shortAnswerPaths[chapter]) {
        shortAnswerPaths.totalQs[chapter] += shortAnswerPaths[chapter][section].length
...
module.exports = { topicsToTest, shortAnswerPaths }