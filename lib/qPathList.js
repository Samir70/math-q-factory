...
const shortAnswerPaths = {
    ...
    algebra01: {
        ...
        substitute: ['6a(positive)-60', '6a(negative)-90', '6+a-80', '6a+2b-100', '6aminus2b+5-110'],
    },
    data: {
    ...
    formulas: {
        ...
        'F=ma': ['findForce-100', 'findMass-150', 'findAcc-150']
    },
    fraction: {
        ...
        toPercentage: ['quarters-50', 'str8toOver100-100', 'simplifyThenToOver100-120'],
        // toPercentage2: ['viaDivision-130'],
        // toDecimal: ['common', 'needBusStop'],
        add: ['sameDenom-80', 'diffDenomChangeOne-180', 'diffDenomChangeBoth-230', 'mixedNumbers-250'],
        multiply: ['ordinary-85', 'mixedNumbers-150'],
    ...
    number: {
        ...
        bidmas: ['a+bxc-80', 'axbtakec-80', 'ax(b+c)-80', 'atakeb+c-100', 'a^2takebxc-100', 'a+(btakec)^2-120'],
    ...
    percent: {
        ofAmount: ['multiplesOf25%-60', 'multiplesOf10%-80', 'multiplesOf5%-100', 'multiplesOf1%-150'],
        // change: ['sales', 'tax'],
        // findChange: [''],
    ...
    sequences: {
        linear: ['findNextTerm-60', 'giveTermToTermRule-100', 'useFormulaTimesTables-110', 'useFormula1to5-180', 'useFormula100s-275', 'findFormula-250'],
    ...
    shape: {
        rectangle: ['areaFromLW-75', 'wFromAreaL-85', 'areaFromPerimSide-120', 'perimFromLW-75', 'wFromPerimL-80', 'perimFromAreaSide-120']
    },
    // quadratic: {
    ...
    // },
    wordy: {
        busStop: ['rnd-185', 'weeks-180', 'prize-180', 'bill-180', 'holiday-230', ],
        findTotal: ['EdexcelSampleAQ01-30', 'fruit&Veg-45'],
        divide: ['EdexcelSampleAQ02-200'],
        multiply: ['EdexcelSampleAQ03-110'],
    }
}

const multiChoicePaths = {
    vocab: {
        angles: ['rnd-50', 'acute-40', 'obtuse-40', 'right-30', 'reflex-80'],
        circles: ['rnd-95', 'diameter-80', 'radius-80', 'tangent-100', 'chord-120'],
        // sequences: [''],
        triangles: ['rnd-60', 'scalene-130', 'isosceles-80', 'equilateral-80'],
        // typesOfNumber: [''],
        // quadrilaterals: ['']
    },
    powers: {
        simplify: ['times-130', 'divide-140', 'brackets-140'],
    },
    wordy: {
        compareMetricUnits: ['EdexcelSampleAQ04-130']
    }
}
