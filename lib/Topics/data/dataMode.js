...
const modeQ = (list, itemType) => {
    ...
    return {
        ...
        qFeedback: modes.length > 2 ? 'Because more than 2 numbers come up equally often' : `${modes.join(' and ')} listed ${tally[modes[0]]} times, that is more often than other ${itemType}`
    }
}
